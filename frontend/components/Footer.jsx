  ...
  return (
    <div className="bg-[#090B0C] text-white">
      <div className="relative">
        ...
        <div className="absolute top-[40%] left-[20%] sm:top-1/2 sm:scale-125 md:scale-100 sm:left-[35%] md:top-[12%] md:left-1/2 xl:top-[15%] xl:left-1/2 2xl:-mt-4 2xl:-ml-20 2xl:top-[25%] z-0">
