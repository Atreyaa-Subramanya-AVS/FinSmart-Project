    ...
    <div className="w-full bg-gradient-to-r from-[#090B0D] via-[#090B0D] via-50% to-[#010103]">
      <div className="hero-content relative md:max-w-screen-2xl w-full mx-auto h-fit max-md:-mt-24">
        <div className="absolute z-10 top-40 max-md:mt-10 ml-8 max-md:ml-4">
          ...
          <p className="relative z-30 max-md:max-w-[25rem] text-gray-100 mt-5 text-xs md:text-sm lg:text-base 2xl:text-lg max-w-lg max-md:text-sm max-md:mt-2 text-pretty max-md:leading-[1.3rem]">
      ...
      <div className="text-white py-12 px-3 xl:ml-5">
        <h1 className="text-slate-400 ">
          Everything you need for financial work:
        </h1>
        <div className=" flex gap-3">
          {[
            ...
            >
              ...
              {indx !== 4 && (
                <div className="mt-1">
                  <div className="bg-slate-300 ml-2 p-[2px] my-4 rounded-full"></div>
                </div>
              )}
            </div>
          ))}
