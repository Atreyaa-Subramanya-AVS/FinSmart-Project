import { HouseIcon, FileUser ,BotMessageSquare,ChartNoAxesCombined } from "lucide-react";
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs";
import AvatarDashboard from "./Avatar";

export default function 
VerticalTab({ tabComponents }) {
  return (
    <Tabs
      defaultValue="tab-1"
    ...
    >
      <TabsList className="text-foreground flex-col gap-1 bg-transparent px-1 py-4 justify-start border border-neutral-300 rounded-md rounded-l-none border-l-0 h-[89svh] w-36 relative">
        <TabsTrigger
          value="tab-1"
